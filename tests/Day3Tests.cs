...
namespace tests
{
    public class Day3Tests
    {
        ...
        public void PartOne(string[] wirePaths, int expectedDistanceToIntersection) 
        {
            int actualDistanceToIntersection = new Day3().CalculateClosestIntersection(wirePaths);

            actualDistanceToIntersection.Should().Be(expectedDistanceToIntersection);
        }
        ...
        public void PartTwo(string[] wirePaths, int expectedStepsToIntersection) 
        {
            int actualDistanceToIntersection = new Day3().CalculateStepsToIntersection(wirePaths);

            actualDistanceToIntersection.Should().Be(expectedStepsToIntersection);
        }
    }
}